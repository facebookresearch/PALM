...
from .utils import Struct, to_np, to_tensor, Tensor, Array, SMPLOutput, SMPLHOutput, MANOOutput
...
class MANO(SMPL):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.register_buffer('hand_pose_offset',
                             to_tensor(data_struct.hands_mean, dtype=self.dtype))
